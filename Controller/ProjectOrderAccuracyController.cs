...
namespace DeploymentTool.Controller
{
    public class ProjectOrderAccuracyController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Update(tblProjectOrderAccuracy tblProjectOrderAccuracy)
        {
            ...
            Misc.Utilities.SetActiveProjectId(Misc.ProjectType.New, tblProjectOrderAccuracy.nStoreId, tblProjectOrderAccuracy);
            ...
            {
                if (!tblProjectAudioExists(tblProjectOrderAccuracy.aProjectOrderAccuracyID))
                {
                    return NotFound();
                }
                else
        ...
        public async Task<IHttpActionResult> Create(tblProjectOrderAccuracy tblProjectOrderAccuracy)
        {
            ...
            //tblProjectOrderAccuracy.ProjectActiveStatus = 1; SantoshPP
            tblProjectOrderAccuracy.aProjectOrderAccuracyID = 0;
            Misc.Utilities.SetActiveProjectId(Misc.ProjectType.New, tblProjectOrderAccuracy.nStoreId, tblProjectOrderAccuracy);
            db.tblProjectOrderAccuracies.Add(tblProjectOrderAccuracy);
            await db.SaveChangesAsync();
