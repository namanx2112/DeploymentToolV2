...
export class DropdownServiceService {
  ...
  GetAllModules() {
    let modules = ["ProjectType", "StoreState", "ConfigurationDriveThrou", "ConfigurationInsideDining", "StackHolderCD", "StackHolderITPM", "NetworkingStatus", "NetworkingPrimaryType"
