...
export class RenderDateChangeTemplateComponent {
  ...
  updateAllCheck() {
    this.allChecked = this.allItems != null && this.allItems.every(t => t.isSelected);
  }
  ...
  setAll(completed: boolean) {
    ...
    this.allItems.forEach(t => (t.isSelected = completed));
  }
  ...
  someComplete(): boolean {
    ...
    return this.allItems.filter(t => t.isSelected).length > 0 && !this.allChecked;
  }
